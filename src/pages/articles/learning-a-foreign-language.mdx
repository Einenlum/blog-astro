...
export const publishedAt = new Date(2017, 7, 18);
export const description =
  'I have been learning German since some time now. Here is what I learned.';
export const title = 'Learning a foreign language — Common mistakes';
...
<SourcedImage
  src="https://res.cloudinary.com/dybam16gk/image/upload/v1668335094/blog_images/learning-foreign-language_wuhdyu.jpg"
