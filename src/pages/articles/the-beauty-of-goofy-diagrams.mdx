...
<ImageWithLegend
    src="https://res.cloudinary.com/dybam16gk/image/upload/v1736947148/blog_images/goofy/diagram-1-colors.png"
    alt="A serious diagram in black, grey and white tones, with pastel colors. The font is Arial style. It has straight lines and squared angles, representing the communication between a server and a client in the Secure Remote Password Protocol"
    legend="Diagram 1*"
></ImageWithLegend>

<ImageWithLegend
    src="https://res.cloudinary.com/dybam16gk/image/upload/v1736947691/blog_images/goofy/diagram-2-2.png"
    alt="A goofy diagram with intense colours, sketches, curved arrows and rounded angles and cursive font, representing the communication between a server and a client in the Secure Remote Password Protocol"
    legend="Diagram 2"
></ImageWithLegend>
...
**Update:** I [was told](https://bsky.app/profile/franklaemmer.de/post/3lfrdibwyk227) my comparison between the two diagrams was not fair. The [first version](https://res.cloudinary.com/dybam16gk/image/upload/v1736895112/blog_images/goofy/diagram-1.png) of the "serious" diagram had no colors, icons or arrow types. I agree. Fixed.
