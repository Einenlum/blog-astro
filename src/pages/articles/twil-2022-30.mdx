...
export const publishedAt = new Date(2022, 7, 2);
export const description = 'TWIL about Python, Databases, Iterators, PHP.';
export const title = 'This Week I Learned: 2022W30';
