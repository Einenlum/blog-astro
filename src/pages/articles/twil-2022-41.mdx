...
export const publishedAt = new Date(2022, 9, 17);
export const description =
  'TWIL about Python, PHP, Sorting, TUI, Tailwind, Interesting Github Repositories, Rust.';
export const title = 'This Week I Learned: 2022W41';
...
[Termwind](https://github.com/nunomaduro/termwind) is a PHP library allowing to use [Tailwind CSS](https://tailwindcss.com/)' syntax to build TUI applications. Not tested yet, but looks interesting.
