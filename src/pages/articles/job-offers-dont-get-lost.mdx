...
export const publishedAt = new Date(2018, 0, 9);
export const title = 'Job offers: Don’t get lost along the way';
...
<NonSourcedImage
  src="https://res.cloudinary.com/dybam16gk/image/upload/v1668335096/blog_images/reddit-offer_lscpnq.png"
  alt="A weird job offer from Reddit"
></NonSourcedImage>
