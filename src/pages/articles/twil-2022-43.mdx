...
export const publishedAt = new Date(2022, 9, 31);
export const description = 'TWIL about Vim, Rust, Containers and UNIX.';
export const title = 'This Week I Learned: 2022W43';
