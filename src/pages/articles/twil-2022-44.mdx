...
export const publishedAt = new Date(2022, 10, 7);
export const description = 'TWIL about Neovim, Git, Lua, Cat, PHP, Laravel.';
export const title = 'This Week I Learned: 2022W44';
